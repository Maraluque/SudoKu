...
IMG_CARGANDO1 = os.path.join(directorio_actual, "img", "cargando1.png")
IMG_CARGANDO2 = os.path.join(directorio_actual, "img", "cargando2.png")
IMG_CARGANDO3 = os.path.join(directorio_actual, "img", "cargando3.png")
IMG_CARGANDO4 = os.path.join(directorio_actual, "img", "cargando4.png")
IMG_CARGANDO5 = os.path.join(directorio_actual, "img", "cargando5.png")
IMG_CARGANDO6 = os.path.join(directorio_actual, "img", "cargando6.png")
IMG_CARGANDO7 = os.path.join(directorio_actual, "img", "cargando7.png")
IMG_CARGANDO8 = os.path.join(directorio_actual, "img", "cargando8.png")
IMG_CARGANDO9 = os.path.join(directorio_actual, "img", "cargando9.png")
